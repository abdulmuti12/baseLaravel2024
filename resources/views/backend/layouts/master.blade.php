                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                        ...
                                        <img class="rounded-circle header-profile-user" src="{{ asset('storage/images/'.'default.jpg') }}"
                                        alt="Header Avatar">
                                        @else
                                        <img class="rounded-circle header-profile-user" src="{{ asset('storage/images/'.Auth::guard('admin')->user()->image) }}"
                                        alt="Header Avatar">
                                        @endif
